...
# Visualization (Race/Ethnicity) -----------------------------------------------

ggplot(race.d.df, aes(x = comparison, y = d, color = comparison)) +
  geom_point(stat = "identity", position = position_dodge(width = 0.75), size = 2) + 
  geom_errorbar(aes(ymin = lower, ymax = upper), width = 0.5) + 
  geom_hline(yintercept = 0, linetype = "dashed", color = "black") + 
  labs(y = expression("Cohen's " ~ italic("d"))) +
  theme_bw() +
...
ggsave("../Plots/pod_race_d.png", width = 9,  height = 6, dpi = "retina")
...
ggplot(gender.d.df, aes(x = comparison, y = d, color = comparison)) +
  geom_point(stat = "identity", position = position_dodge(width = 0.75), size = 2) + 
  geom_errorbar(aes(ymin = lower, ymax = upper), width = 0.5) + 
  geom_hline(yintercept = 0, linetype = "dashed", color = "black") + 
  labs(y = expression("Cohen's " ~ italic("d"))) +
...
ggsave("../Plots/pod_gender_d.png", width = 9,  height = 6, dpi = "retina")
